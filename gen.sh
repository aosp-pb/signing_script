...
echo "Done! Now build as usual. If builds aren't being signed, add '-include vendor/aospb-priv/keys/keys.mk' to your device mk file"
echo "Make copies of your vendor/aospb-priv folder or upload it to a private repository as it contains your keys!"
sleep 3